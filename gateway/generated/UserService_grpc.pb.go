...
type UserServiceClient interface {
	...
	LogoutUser(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *userServiceClient) LogoutUser(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type UserServiceServer interface {
	...
	LogoutUser(context.Context, *LogoutRequest) (*Empty, error)
...
func (UnimplementedUserServiceServer) LogoutUser(context.Context, *LogoutRequest) (*Empty, error) {
