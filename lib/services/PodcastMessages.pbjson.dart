...
const PodcastHost$json = {
  ...
  '2': [
    ...
    {'1': 'voiceTags', '3': 4, '4': 3, '5': 11, '6': '.Tag', '10': 'voiceTags'},
    {'1': 'personalityTags', '3': 5, '4': 3, '5': 11, '6': '.Tag', '10': 'personalityTags'},
  ],
};
...
final $typed_data.Uint8List podcastHostDescriptor = $convert.base64Decode(
    ...
    '5kZXIYAyABKAlSBmdlbmRlchIiCgl2b2ljZVRhZ3MYBCADKAsyBC5UYWdSCXZvaWNlVGFncxIu'
    'Cg9wZXJzb25hbGl0eVRhZ3MYBSADKAsyBC5UYWdSD3BlcnNvbmFsaXR5VGFncw==');
...
const Podcast$json = {
  ...
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 5, '10': 'id'},
    {'1': 'name', '3': 2, '4': 1, '5': 9, '10': 'name'},
    {'1': 'topics', '3': 3, '4': 3, '5': 11, '6': '.Tag', '10': 'topics'},
    {'1': 'hosts', '3': 4, '4': 3, '5': 11, '6': '.PodcastHost', '10': 'hosts'},
  ],
};
...
final $typed_data.Uint8List podcastDescriptor = $convert.base64Decode(
    'CgdQb2RjYXN0Eg4KAmlkGAEgASgFUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhwKBnRvcGljcx'
    'gDIAMoCzIELlRhZ1IGdG9waWNzEiIKBWhvc3RzGAQgAygLMgwuUG9kY2FzdEhvc3RSBWhvc3Rz');
...
const CreatePodcastRequest$json = {
  ...
  '2': [
    ...
    {'1': 'podcast', '3': 2, '4': 1, '5': 11, '6': '.Podcast', '10': 'podcast'},
  ],
};
...
final $typed_data.Uint8List createPodcastRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVQb2RjYXN0UmVxdWVzdBIWCgZ1c2VySWQYASABKAVSBnVzZXJJZBIiCgdwb2RjYX'
    'N0GAIgASgLMgguUG9kY2FzdFIHcG9kY2FzdA==');
